                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-lg-offset-4">
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::file("ticket_holder_profile_photo[{$i}][{$ticket['ticket']['id']}]", [ 'required' => 'required', 'accept' => 'image/*', 'oninvalid'=> "this.setCustomValidity('Upload your profile photo')", 'oninput'=> "setCustomValidity('')", 'class' => "ticket_holder_profile_photo.$i.{$ticket['ticket']['id']} ticket_holder_profile_photo custom_upload"]) !!}
                                                </div>
                                            </div>
                                        </div>

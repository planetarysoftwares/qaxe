...
return array (
  'all_attendees' => 'All Passengers',
  'all_attendees_cancelled' => 'All passengers in this order have been cancelled.',
  'all_order_refunded' => 'All :money of this order has been refunded.',
  'amount' => 'Amount',
  'attendee_cancelled' => 'Cancelled',
  'attendee_cancelled_help' => 'This passenger has been cancelled',
  ...
  'cancel_description' => 'Cancelling Passengers will remove them from the passenger list.',
  'cancel_notify' => 'Notify :name their ticket has been cancelled.',
  'cancel_order_:ref' => 'Cancel Order: :ref',
  'cancel_refund' => 'If you would like to refund the order which this passenger belongs to you can do so <strong><a href=":url">here</a></strong>.',
  ...
  'check-in' => 'Check-In',
  'checkin_search_placeholder' => 'Search by Passenger Name, Order Reference, Passenger Reference...',
  'close' => 'close',
  'confirm_cancel' => 'Confirm cancel passenger',
  'confirm_order_cancel' => 'Confirm Order Cancel',
  'create_attendees' => 'Create Passengers',
  'create_ticket' => 'Create Ticket',
	'default_currency' => 'Default currency',
  'download_pdf_ticket' => 'Download PDF Ticket',
  'edit_attendee' => 'Edit Passenger',
  'edit_attendee_title' => 'Edit :passenger',
  'edit_order_title' => 'Order: :order_ref',
  'edit_question' => 'Edit Question',
  'edit_ticket' => 'Edit Ticket',
  'end_sale_on' => 'End Sale On',
  'event_not_live' => 'This Destination is not visible to the public.',
  'event_page' => 'Destination Page',
  'event_tools' => 'Destination Tools',
  'export' => 'Export',
  'go_to_attendee_name' => 'Go to passenger :name',
  'hide_this_ticket' => 'Hide This Ticket',
  'import_file' => 'Import File',
  'invite_attendee' => 'Invite Passenger',
  'invite_attendees' => 'Invite Passengers',
  ...
  'message_attendee_title' => 'Message :passenger',
  'message_attendees' => 'Message',
  'message_attendees_title' => 'Message Passengers',
  'message_order' => 'Message :order',
  'minimum_tickets_per_order' => 'Minimum Tickets Per Order',
  'more_options' => 'More options',
  'no_attendees_matching' => 'No passengers matching',
  'no_attendees_yet' => 'No Passengers yet',
  'no_attendees_yet_text' => 'Passengers will appear here once they successfully registered for your Destination, or, you can manually invite passengers yourself.',
  ...
  'print_attendee_list' => 'Print Passenger List',
  ...
  'resend_ticket_help' => 'The passenger will be sent another copy of their ticket to :email',
  'resend_ticket_to_attendee' => 'Resend Ticket to :passenger',
  ...
  'select_attendee_to_cancel' => 'Select any passenger tickets you wish to cancel.',
  'send_invitation_n_ticket_to_attendees' => 'Send invitation & ticket to passengers',

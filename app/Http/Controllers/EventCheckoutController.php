    ...
    public function postValidateTickets(Request $request, $event_id)
    {
        ...
        foreach ($ticket_ids as $ticket_id) {
            ...
            for ($i = 0; $i < $current_ticket_quantity; $i++) {
                 ...
                 */
                $validation_rules['ticket_holder_profile_photo.' . $i . '.' . $ticket_id] = ['required','image', 'mimes:jpeg,jpg,png,tif,gif', 'max:10000']; //LU: Add ticket profile photo validation rule
